...
• The app includes Cocoapods and the AFNetworking library.  The AFNetworking library provides easier ways to verify network connectivity, to load data and images asynchronously, to cache images, and to parse JSON responses.
